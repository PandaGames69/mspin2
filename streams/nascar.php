    ...
    <div class="stream-page-god-wrapper">
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=KNBC'">
              <p>Stream 1</p>
          </button>

          <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=TSN5CA'">
            <p>Stream 2</p>
          </button>

          <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/NBC[USA]'">
            <p>Stream 3</p>
          </button>

          <!-- <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=NASCAR'">
            <p>Stream 3</p>
          </button> -->

          <!-- <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=PS2RI_CF'">
            <p>Stream 4</p>
          </button> -->

          <!-- <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SP1PLDE'">
            <p>Stream 4</p>
          </button> -->

          <!-- <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/USANetwork[USA]'">
            <p>Stream 6</p>
          </button> -->

          <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=ADS2'">
            <p>Stream</p>

      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/beinspmalysia3.php'">
              <p>Stream 1</p>
            </button>
            ...
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/SuperSportPremierLeague[SouthAfrica]'">
              <p>Stream 3</p>
            </button>

            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.sx/embed/stream-61.php'">
              <p>Stream 4</p>
            </button>

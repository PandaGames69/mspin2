      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/PremierSports1[UK]'">
              <p>Stream 1</p>
            </button>

            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://wikisport.se/embed/ps1.php'">
              <p>Stream 2</p>
            </button>

            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/SuperSportLaLiga[SouthAfrica]'">
              <p>Stream 3</p>
            </button>

            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-276.php'">
              <p>Stream 4</p>
            </button> 

            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-375.php'">
              <p>Stream</p>

      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/PremierSports2[UK]'">
              <p>Stream 1</p>
            </button>

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://wikisport.se/embed/ps2.php'">
              <p>Stream 2</p>
            </button>

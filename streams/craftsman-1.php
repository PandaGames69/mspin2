  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\craftsman.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
           ...
           <!-- Btn1 -->
           <!-- <button class="feed-button feed-button-craftsman" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw2?id=OFFLINE'">
              <p>Stream 1</p>
            </button> -->
...
<!-- 
            <button class="feed-button feed-button-craftsman" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw?id=FS1MX'">
              <p>Stream 1</p>
            </button> -->

            <button class="feed-button feed-button-craftsman" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/FOXSports2[USA]'">
              <p>Stream 1</p>
            </button>
          </div>

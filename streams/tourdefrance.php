      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <!-- <button class="feed-button feed-button-nascar" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/Eurosport1[UK]'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-41.php'">
              <p>Stream 2</p>
            </button>

            <!-- Btn3 -->
            <!-- <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://wikisport.se/fsl/euro1.php'">
              <p>Stream 3</p>
            </button> -->

            <!-- Btn4 -->
            <!-- <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/charlie/nurburgring-race-1/2'">
              <p>RACE ONLY</p>
            </button> -->

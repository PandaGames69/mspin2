      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=TNTSP3UK'">
              <p>Stream 1</p>
            </button>
<!-- 
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw?id=TNTSP3UK_CF'">
              <p>Stream 2</p>
            </button> -->
            ...
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/tnt3.php'">
              <p>Stream 3</p>
            </button>

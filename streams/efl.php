  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\efl.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-efl" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/alpha/afc-wimbledon-vs-newcastle-united/1'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <!-- <button class="feed-button feed-button-efl" onclick="document.getElementById('feed-iframe').src = 'https://sportsurge.stream/embed/efl.php'">
              <p>Stream</p>
            </button> -->

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-efl" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\erc.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-erc" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=RALLYTV'">
              <p>Stream 1</p>
            </button>
            <!-- <button class="feed-button feed-button-erc" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=TNTSP5UK'">
              <p>Stream 2</p>
            </button>
            <button class="feed-button feed-button-erc" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=TNTSP5UK_H'">
              <p>Stream 3</p>
            </button> -->

      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn2 -->
            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpf?id=SSMEUK_CF'">
              <p>Stream 1</p>
            </button>

            <!-- <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SSMEUK_CF'">
              <p>Stream 2</p>
            </button> -->

            <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SSPLUK_CF'">
              <p>Stream 3</p>
            </button>

            <!-- Btn1 -->
            <!-- <button class="feed-button feed-button-premier" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/usanet.php'">
              <p>Stream 4</p>
            </button> -->

  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\dtm.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/SuperSportVariety3[SouthAfrica]'">
              <p>Stream 1</p>
            </button>
            ...
            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-dtm" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\ligue1.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-ligue1" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/sky-sports-ligue1-sky-ligue1/1'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <button class="feed-button feed-button-ligue1" onclick="document.getElementById('feed-iframe').src = 'https://sportsurge.stream/embed/ligue1.php'">
              <p>Stream</p>
              <img src="..\media\svg\custom-flags\italy.svg" alt="">
            </button>

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-ligue1" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

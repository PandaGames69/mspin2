  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\arca.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <!-- <button class="feed-button feed-button-arca" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/FOXSports1[USA]'">
              <p>Stream 1</p>
            </button> -->
             <button class="feed-button feed-button-arca" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/FOXSports2[USA]'">
              <p>Stream 1</p>
            </button>

            <!-- <button class="feed-button feed-button-arca" onclick="document.getElementById('feed-iframe').src = 'https://stream.crichd.vip/update/sky5nz.php'">
              <p>Stream 2</p>
            </button> -->

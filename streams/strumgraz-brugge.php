      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/alpha/sk-sturm-graz-vs-club-brugge/1'">
              <p>Stream 1</p>
            </button>

            <!-- <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw?id=TNTSP5UK_CF'">
              <p>Stream 2</p>
            </button>

            <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/stream1.php'">
              <p>Stream 3</p>
            </button> -->

            <!-- <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/tnt1.php'">
              <p>Stream 4</p>
            </button> -->

            <!-- <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/TNTSports5[UK]'">
              <p>Stream 5</p>
            </button> -->

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-champions" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw2?id=OFFLINE'">
              <p>Stream 1</p>
            </button> -->
          </div>

      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-nations" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/sky-sports-nations-sky-nations/1'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <button class="feed-button feed-button-nations" onclick="document.getElementById('feed-iframe').src = 'https://sportsurge.stream/embed/nations.php'">
              <p>Stream</p>
              <img src="..\media\svg\custom-flags\italy.svg" alt="">
            </button>

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-nations" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

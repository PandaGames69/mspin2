  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\laliga.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-craftsman" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button> -->

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://foothubhd.live/cast/1/premiersports1.php'">
              <p>Stream 1</p>
            </button>

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://wikisport.se/embed/ps1.php'">
              <p>Stream 2</p>
            </button>

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/SuperSportLaLiga[SouthAfrica]'">
              <p>Stream 3</p>
            </button>

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-276.php'">
              <p>Stream 4</p>
            </button> 

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/LaLigaTV[UK]'">
              <p>Stream 5</p>
            </button> 

            <button class="feed-button feed-button-laliga" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-375.php'">
              <p>Stream</p>

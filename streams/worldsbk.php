  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\worldsbk.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <!-- <button class="feed-button feed-button-f1"
              onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
          </button> -->

            <!-- Btn1 -->
            <button class="feed-button feed-button-worldsbk" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SPOTV'">
              <p>Stream 1</p>
            </button>

            <button class="feed-button feed-button-worldsbk" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SPOTV_3'">
              <p>Stream 2</p>
            </button>

            <!-- <button class="feed-button feed-button-worldsbk" onclick="document.getElementById('feed-iframe').src = 'https://'">
              <p>Stream 3</p>
            </button> -->

            <button class="feed-button feed-button-worldsbk" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.so/embed/stream-592.php'">
              <p>Stream 3</p>
            </button>

      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-nfl" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/alpha/green-bay-packers-vs-minnesota-vikings/11'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <button class="feed-button feed-button-nfl" onclick="document.getElementById('feed-iframe').src = 'https://embedme.top/embed/alpha/green-bay-packers-vs-minnesota-vikings/2'">
              <p>Stream 2</p>
            </button>

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-nfl" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/hls?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

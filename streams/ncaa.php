      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <!-- Btn1 -->
            <button class="feed-button feed-button-nfl" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=TSN3CA'">
              <p>Stream 1</p>
            </button>

            <!-- Btn2 -->
            <button class="feed-button feed-button-nfl" onclick="document.getElementById('feed-iframe').src = 'https://topembed.pw/channel/TSN3[CA]'">
              <p>Stream</p>
            </button>

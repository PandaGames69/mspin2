  ...
  <div class="single-streams-page-content">
    ...
    <div class="stream-page-title-wrapper">
      <div class="stream-page-title">
        <img src="..\media\svg\series-title\bundesliga.svg" alt="">
      </div>
      ...
      <div class="streams-col-left">
        ...
        <div class="stream-page-buttons-wrapper">
          ...
          <div class="feed-buttons-wrapper">
            ...
            <button class="feed-button feed-button-bundesliga" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=BSPORTS3MY_UNIFI'">
              <p>Stream 1</p>
            </button>
            <button class="feed-button feed-button-bundesliga" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/mpd?id=SSFTUK_CF'">
              <p>Stream 2</p>
            </button>

            <button class="feed-button feed-button-bundesliga" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.sx/embed/stream-8.php'">
              <p>Stream 3</p>
            </button>

            <!-- Btn2 -->
            <!-- <button class="feed-button feed-button-bundesliga" onclick="document.getElementById('feed-iframe').src = 'https://dlhd.sx/embed/stream-260.php'">
              <p>Stream 3</p>
            </button> -->

            <!-- OFFLINE -->
            <!-- <button class="feed-button feed-button-bundesliga" onclick="document.getElementById('feed-iframe').src = 'https://mazespin.live/channel/raw2?id=OFFLINE'">
              <p>Stream 1</p>
            </button>             -->
          </div>

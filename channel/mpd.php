...
<script src="https://cdn.jsdelivr.net/npm/dash-shaka-playback@3.4.0/dist/dash-shaka-playback.min.js"></script>
        ...
        fetch('/media/list/shaka.json')
            ...
            .then(data => {
                ...
                if (data.hasOwnProperty(channelID)) {
                    ...
                    let fallbackURL = 'https://prx3.mazespin.live/' + primaryURL;
                    $.ajax({
                        url: primaryURL,
                        type: 'GET',
                         success: function() {
                            setupClappr(primaryURL);
                        },
                        error: function() {
                            setupClappr(fallbackURL);
                            }
                    });
                    // Clappr Set-Up
